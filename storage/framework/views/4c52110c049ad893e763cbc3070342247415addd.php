                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 align-middle">
                                        <select class="custom-select" name="qty" id="qty" data-id="<?php echo e($product->rowId); ?>">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <option value="<?php echo e($i); ?>" <?php echo e($product->qty == $i ? 'selected' : ''); ?>>
                                                    <?php echo e($i); ?>
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        </ul><a href="<?php echo e(route('checkout.index')); ?>" class="btn btn-dark rounded-pill py-2 btn-block"><i class="fa fa-credit-card" aria-hidden="true"></i> Passer à la caisse</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aurelien/Bureau/First_Site/resources/views/cart/index.blade.php ENDPATH**/ ?>